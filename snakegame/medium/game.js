...
const best_score_medium_num = document.querySelector('.best-score-num');
...
let score;
let best_score_medium = 0;

if (localStorage.getItem("best_score_medium") !== null) {
    best_score_medium = (localStorage.getItem("best_score_medium"))
    if (best_score_medium > 9) {
        best_score_medium_num.textContent = best_score_medium;
    } else {
        best_score_medium_num.textContent = '0' + best_score_medium;
    }
}
...
function moveEverything() {
    ...
    if (snakePosX === foodPosX && snakePosY === foodPosY) {
        ...
        if (score > best_score_medium) {
            ...
            localStorage.setItem("best_score_medium", best_score_medium)
        }
    }
}
